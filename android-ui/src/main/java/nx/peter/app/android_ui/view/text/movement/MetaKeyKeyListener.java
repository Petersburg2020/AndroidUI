...
public abstract class MetaKeyKeyListener {
     ...
     */
    public static final int META_CAP_LOCKED = KeyEvent.META_CAPS_LOCK_ON;
    
    /**
     * Flag that indicates that the ALT key is locked.
     */
    public static final int META_ALT_LOCKED = 0x200; // KeyEvent.META_ALT_LOCKED;
    
    /**
     * Flag that indicates that the SYM key is locked.
     */
    public static final int META_SYM_LOCKED = 0x400; // KeyEvent.META_SYM_LOCKED;
    
    /**
     * @hide pending API review
     */
    public static final int META_SELECTING = 0x800; // KeyEvent.META_SHIFT_RIGHT_ON | KeyEvent.META_FUNCTION_ON;
