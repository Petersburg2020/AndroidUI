...
import nx.peter.app.android_ui.view.pdf.adapter.BitmapContainer;
import nx.peter.app.android_ui.view.pdf.adapter.PdfErrorHandler;
import nx.peter.app.android_ui.view.pdf.adapter.PdfRendererParams;
import nx.peter.app.android_ui.view.pdf.adapter.SimpleBitmapPool;

import java.io.File;
import java.io.IOException;
import java.net.URI;

class BasePDFPagerAdapter extends PagerAdapter {
    protected static final int FIRST_PAGE = 0;
    protected static final float DEFAULT_QUALITY = 2.0f;
    protected static final int DEFAULT_OFFSCREEN_SIZE = 1;
    ...
    public BasePDFPagerAdapter(Context context, String pdfPath) {
        ...
        this.offScreenSize = DEFAULT_OFFSCREEN_SIZE;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) ImageView iv = v.findViewById(R.id.imageView);

        if (renderer == null || getCount() < position) return v;
    ...
    protected void releaseAllBitmaps() {
        if (bitmapContainer != null) bitmapContainer.clear();
    }
